...
- Create Angular project with ng: `ng new clinicappointment.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`clinicappointment.client.esproj`).
